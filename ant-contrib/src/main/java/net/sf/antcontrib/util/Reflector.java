...
/**
 * Utility class to handle reflection on java objects. Its main purpose is to
 * allow ant-contrib classes to compile under ant1.5 but allow the classes to
 * use ant1.6 classes and code if present. The class is a holder class for an
 * object and uses java reflection to call methods on the objects. If things go
 * wrong, BuildExceptions are thrown.
 * 
 * @author Peter Reilly
 */
...
public class Reflector {
	...
	/**
	 * Call a method with an object using a specific type as for the method
	 * parameter.
	 * 
	 * @param methodName
	 *            the name of the method
	 * @param className
	 *            the name of the class of the parameter of the method
	 * @param o
	 ...
	 *            the name of the method
	 * @param classType
	 *            the class of the parameter of the method
	 * @param o
	 *            the object to use as the argument of the method
	 * @return the object returned by the method
	 */
	 ...
	 *            the name of the method to call
	 * @param o
	 *            the object to use as the parameter, this must be of the same
	 *            type as the method parameter (not a subclass).
	 * @return the object returned by the method
	 */
	public Object call(String methodName, Object o) {
		try {
			Method method;
			method = obj.getClass().getMethod(methodName, new Class[] { o.getClass() });
			return method.invoke(obj, new Object[] { o });
		} catch (InvocationTargetException t) {
			Throwable t2 = t.getTargetException();
			if (t2 instanceof BuildException) {
	 ...
	 *            the name of the method to call
	 * @param o1
	 *            the object to use as the first parameter, this must be of the
	 *            same type as the method parameter (not a subclass).
	 * @param o2
	 *            the object to use as the second parameter, this must be of the
	 *            same type as the method parameter (not a subclass).
	 * @return the object returned by the method
	 */
	public Object call(String methodName, Object o1, Object o2) {
		try {
			Method method;
			method = obj.getClass().getMethod(methodName, new Class[] { o1.getClass(), o2.getClass() });
