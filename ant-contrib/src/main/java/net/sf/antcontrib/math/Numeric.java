...
public class Numeric implements Evaluateable {
	 ...
	 * datatype, for example, setting value to "7.992" and datatype to INT will
	 * cause a number format exception to be thrown. Supports two special
	 * numbers, "E" and "PI".
	 *
	 * @param value
	...
	/**
	 * Sets the datatype of this number. Allowed values are "int", "long",
	 * "float", or "double".
	 */
	...
	public String toString() {
		return "Numeric[value=" + value + ";datatype=" + datatype + "]";
	}
}
