...
public class Math {
	public static final Number evaluate(String operation, String datatype, boolean strict, Evaluateable operands[]) {
		...
		try {
			...
			Method m = Math.class.getDeclaredMethod(operation,
					new Class[] { String.class, Boolean.TYPE, operands.getClass() });
			Number n = (Number) m.invoke(null,
					new Object[] { datatype, strict ? Boolean.TRUE : Boolean.FALSE, operands });
	...
	public static final Number execute(String method, String datatype, boolean strict, Class paramTypes[],
			Object params[]) {
		try {
			Class c = null;
			if (strict) {
	...
	public static final Number random(String datatype, boolean strict, Evaluateable operands[]) {
		return execute("random", datatype, strict, new Class[0], new Object[0]);
	}
	...
	public static final Number abs(String datatype, boolean strict, Evaluateable operands[]) {
		...
		return execute("abs", datatype, strict, params, ops);
	}

	private static final Number doOneDoubleArg(String operation, String datatype, boolean strict,
			Evaluateable operands[]) {
		Object ops[] = new Object[] { convert(operands[0].evaluate(), "double") };
		Class params[] = new Class[] { Double.TYPE };

		return execute(operation, datatype, strict, params, ops);
	}
	...
	public static final Number atan2(String datatype, boolean strict, Evaluateable operands[]) {
		...
		return execute("atan2", datatype, strict, params, ops);
	}
	...
	public static final Number round(String datatype, boolean strict, Evaluateable operands[]) {
		...
		return execute("round", datatype, strict, params, ops);
	}
	...
	public static final Number ieeeremainder(String datatype, boolean strict, Evaluateable operands[]) {
		...
		return execute("IEEERemainder", datatype, strict, params, ops);
	}

	public static final Number min(String datatype, boolean strict, Evaluateable operands[]) {
		Object ops[] = new Object[] { convert(operands[0].evaluate(), datatype),
				convert(operands[1].evaluate(), datatype) };
		Class params[] = new Class[] { getPrimitiveClass(datatype), getPrimitiveClass(datatype) };

		return execute("min", datatype, strict, params, ops);
	}
	...
	public static final Number max(String datatype, boolean strict, Evaluateable operands[]) {
		...
		return execute("max", datatype, strict, params, ops);
	}
