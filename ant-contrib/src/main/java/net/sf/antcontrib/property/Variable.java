 ...
 * property.
 * <p>
 * This used to be a nice little task that took advantage of what is probably a
 * flaw in the Ant Project API -- setting a "user" property programatically
 * causes the project to overwrite a previously set property. Now this task has
 * become more violent and employs a technique known as "object rape" to
...
public class Variable extends Task {
	 ...
	 * table. Note that Ant 1.6 uses a helper for this.
	 */
