...
public abstract class AbstractHttpStateTypeTask extends Task {
	...
	static HttpStateType getStateType(Project project, String stateRefId) {
		...
		if (stateRef == null) {
			throw new BuildException("Reference '" + stateRefId + "' is not defined.");
		}
		if (!(stateRef instanceof HttpStateType)) {
			throw new BuildException("Reference '" + stateRefId + "' is not of the correct type.");
		}
	...
	protected abstract void execute(HttpStateType stateType) throws BuildException;
}
