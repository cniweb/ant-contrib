 ...
 * run. If one of them should throw a {@link org.apache.tools.ant.BuildException
 * BuildException} several things can happen:
 * </p>
 *
 * <ul>
...
public class TryCatchTask extends Task {
	...
	public void execute() throws BuildException {
		...
		try {
			...
			if (property != null) {
				/*
				 * Using setProperty instead of setNewProperty to be able to
				 * compile with Ant < 1.5.
				 */
