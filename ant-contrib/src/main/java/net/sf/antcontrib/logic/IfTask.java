 ...
 *
 * <p>
 * This task is heavily based on the Condition framework that can be found in
 * Ant 1.4 and later, therefore it cannot be used in conjunction with versions
 * of Ant prior to 1.4.
 * </p>
 *
 * <p>
 * This task doesn't have any attributes, the condition to test is specified by
 * a nested element - see the documentation of your
 * <code>&lt;condition&gt;</code> task (see
 * <a href="http://jakarta.apache.org/ant/manual/CoreTasks/condition.html">the
 * online documentation</a> for example) for a complete list of nested elements.
 * </p>
 *
 * <p>
 * Just like the <code>&lt;condition&gt;</code> task, only a single condition
 * can be specified - you combine them using <code>&lt;and&gt;</code> or
 * <code>&lt;or&gt;</code> conditions.
 * </p>
 *
 * <p>
 * In addition to the condition, you can specify three different child elements,
 * <code>&lt;elseif&gt;</code>, <code>&lt;then&gt;</code> and
 * <code>&lt;else&gt;</code>. All three subelements are optional.
 *
 * Both <code>&lt;then&gt;</code> and <code>&lt;else&gt;</code> must not be used
 * more than once inside the if task. Both are containers for Ant tasks, just
 * like Ant's <code>&lt;parallel&gt;</code> and <code>&lt;sequential&gt;</code>
 * tasks - in fact they are implemented using the same class as Ant's
 * <code>&lt;sequential&gt;</code> task.
 * </p>
 *
 * The <code>&lt;elseif&gt;</code> behaves exactly like an
 ...
 * evaluated in. If the condition on the <code>&lt;if&gt;</code> is false, then
 * the first <code>&lt;elseif&gt;</code> who's conditional evaluates to true
 * will be executed. The <code>&lt;else&gt;</code> will be executed only if the
 * <code>&lt;if&gt;</code> and all <code>&lt;elseif&gt;</code> conditions are
 * false.
 *
 * <p>
 * Use the following task to define the <code>&lt;if&gt;</code> task before you
...
public class IfTask extends ConditionBase {
	...
	/**
	 * A nested &lt;then&gt; element - a container of tasks that will be run if
