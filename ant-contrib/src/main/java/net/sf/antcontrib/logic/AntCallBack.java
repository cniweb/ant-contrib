...
public class AntCallBack extends Task {
	...
	public void execute() throws BuildException {
		...
		try {
			...
			log("calling target " + (target != null ? target : "[default]") + " in build file " + antFile.toString(),
					Project.MSG_VERBOSE);
			...
			if (newProject.getBaseDir().equals(project.getBaseDir())
					...
					&& getOwningTarget() != null && target.equals(this.getOwningTarget().getName())) {
	 ...
	 * Defaults to the current project's basedir, unless inheritall has been set
	 * to false, in which case it doesn't have a default value. This will
	 ...
	 *
	 * @param r
	 *            the name of a property in the new project to set in the
	 *            original project. This may be a comma separate list of
	 *            properties.
	 */
	...
	public static class Reference extends org.apache.tools.ant.types.Reference {
		 ...
		 *
		 * @param targetid
		 *            the id under which this reference will be passed to the
		 *            new project
		 */
