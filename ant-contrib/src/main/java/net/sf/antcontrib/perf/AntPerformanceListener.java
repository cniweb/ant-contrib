 ...
 * command line with the -D option (-Dperformance.log=/tmp/performance.log) or
 * in the build file itself (
 * <property name="performance.log" location="/tmp/performance.log"/>).
 * <p>
...
public class AntPerformanceListener implements BuildListener {
	...
	private HashMap targetStats = new HashMap(); // key is Target, value is
													// StopWatch
	private HashMap taskStats = new HashMap(); // key is Task, value is
												// StopWatch
