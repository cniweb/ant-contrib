...
public class IniFile {
	...
	/***
	 * Sets an IniSection object. If a section with the given name already
	 * exists, it is replaced with the passed in section.
	 * 
	 * @param section
	 *            The section to set.
	 */
	...
	/***
	 * Sets the value of a property in a given section. If the section does not
	...
	/***
	 * Reads from a Reader into the current IniFile instance. Reading appends to
	 * the current instance, so if the current instance has properties, those
